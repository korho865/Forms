...
function singupAction( pervFormState,formData){
  ...
  if (!isEqualToOtherValue(password, confrimPassword)){
    errors.push('Passwords do not mach');
  }
      ...
      <div className="control-row">
        ...
        <div className="control">
          ...
          <input
            ...
            defaultValue={formState.enteredValues?.confrimPassword}
          />
        </div>
      </div>
